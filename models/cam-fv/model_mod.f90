...
! KDR level doesn't work after the upgrade to cheyenne (2019-7-3)
! And it was wrong after we changed from integer levels to physical unit levels.
...
! KDR; here's a bug fix; my_status should be defined in these cases.
...
! KDR; if we have base_type already, why re-acquire it?
