...
integer, parameter, public :: &
                               SYN_SEAICE_CONCENTR =     1, &
                            SAT_U_SEAICE_COMPONENT =     2, &
                            SAT_V_SEAICE_COMPONENT =     3, &
                               SAT_SEAICE_CONCENTR =     4, &
                                 SAT_SEAICE_VOLUME =     5, &
                             SAT_SEAICE_SNOWVOLUME =     6, &
                            SAT_SEAICE_SURFACETEMP =     7, &
                                     SAT_SEAICE_FY =     8, &
                               SAT_SEAICE_AGREG_FY =     9, &
                      SAT_SEAICE_AGREG_SURFACETEMP =    10, &
                        SAT_SEAICE_AGREG_FREEBOARD =    11, &
                         SAT_SEAICE_AGREG_CONCENTR =    12, &
                           SAT_SEAICE_AGREG_VOLUME =    13, &
                       SAT_SEAICE_AGREG_SNOWVOLUME =    14, &
                        SAT_SEAICE_AGREG_THICKNESS =    15, &
                        SAT_SEAICE_AGREG_SNOWDEPTH =    16
