function compare_monthly_profiles(files, titles, obsnames, copy, prpo, varargin)
...
%
% USAGE: compare_monthly_profiles(files, titles, obsnames, copy, prpo, 'MarkerSize', 6, 'LineWidth', 1.0)
%
...
%
% MarkerSize  : real number controlling the size of the symbols
% LineWidth   : real number controlling the size of the symbols
%
...
% prpo     = 'both';
%
% compare_monthly_profiles(files, titles, obsnames, copy, prpo)
%
...
%
% compare_monthly_profiles(files, titles, obsnames, copy, prpo,'plevel',[Inf 100])
%
% compare_monthly_profiles(files, titles, obsnames, copy, prpo, ...
...
if (exist('inputParser/addParameter','file') == 2)
    ...
    addParameter(p,'LineWidth',  default_LineWidth,  @isnumeric);
    ...
    addParamValue(p,'LineWidth', default_LineWidth,  @isnumeric); %#ok<NVREPL>
...
figuredata.LineWidth  = p.Results.LineWidth;
...
for i = 1:nexp
    ...
    varexist(filenames{i}, {targets{:}}) %#ok<CCAT>
...
set(get(ax1,'Xlabel'),'String',{plotobj.xlabel}, ...
    'Interpreter','none','FontSize',figuredata.fontsize)
